...
import { Home, FileText, Users, MessageSquare, Network, Folder, Settings, Bell, Calendar } from "lucide-react";
import { useIsMobile } from "~/hooks/use-mobile";
import { Badge } from "../ui/badge";
import Link from "next/link";
import type { FC } from "react";
import { Sidebar, SidebarContent, SidebarGroup, SidebarGroupContent, SidebarGroupLabel, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarSeparator, SidebarTrigger, useSidebar } from "../ui/sidebar";
...
const DashboardSidebar: FC = () => {
  ...
  return (
    <Sidebar
      className={`border-r border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900 ${isCollapsed ? "w-16" : isMobile ? "w-64" : "w-64"
